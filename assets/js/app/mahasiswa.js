...
function showMessage(mode) {
	var divMessage =
		...
		"</strong> Data Siswa" +
		"</div>";
	$(divMessage).prependTo(".ini").delay(2000).slideUp("slow");
}
		...
		success: function (data) {
			...
			for (i = 0; i < data.length; i++) {
				html +=
					...
					"</td>" +
					"<td>" +
					konversiJekel(data[i].jekel) +
					"</td>" +
					"<td>" +
					data[i].prodi +
					"</td>" +
					"<td>" +
					konversiSemester(data[i].semester) +
					"</td>" +
					"<td>" +
					data[i].kelas +
					"</td>" +
					"<td  style='width:70px;'><button id='rubah' class='btn btn-info btn-block' data-id='" +
					data[i].nim +
					"'>" +
					"<span class='icon-pencil'></span> Rubah</button>" +
					"</td>" +
					"<td style='width:100px;'><button id='reset' class='btn btn-warning btn-block' data-id='" +
					data[i].nim +
					"'>" +
					"<span class='icon-refresh'></span> Reset Pass</button>" +
					"</td>" +
					"<td style='width:70px;'><button class='btn btn-danger btn-block' id='hapus' data-id='" +
					data[i].nim +
					"'>" +
