		...
		success: function (data) {
			...
			for (i = 0; i < data.length; i++) {
				html +=
					...
					konversiJurusan(data[i].prodi) +
					"</td>" +
					"<td style='width:50px; text-align:center;'>" +
					konversiSemester(data[i].semester) +
					"</td>" +
					"<td><button style='width:70px;' id='rubah' class='btn btn-info btn-block' data-id='" +
					data[i].kodemk +
					"'>" +
					"<span class='icon-pencil'></span> Rubah</button>" +
					"</td>" +
					"<td><button style='width:70px;' class='btn btn-danger btn-block' id='hapus' data-id='" +
					data[i].kodemk +
					"'>" +
