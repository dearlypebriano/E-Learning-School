...
<li class="submenu open"> <a href="#"><i class="icon icon-th-list"></i> <span>Manage Mata Pelajaran</span> <span
			class="icon icon-chevron-down pull-right" style="margin-right: 5px;"></span></a>
	<ul>
		<li class="active"><a href="matakuliah">Mata Pelajaran</a></li>
...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a
				href="matakuliah" class="current">Mata Pelajaran</a> </div>
		<h1><span class="icon-briefcase"></span>
			Manajemen Informasi <small>Data Mata Pembelajaran</small></h1>
	</div>
	<hr>
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" action="">
							...
							<div class="control-group">
								<label class="control-label" for="namamk">Nama Mata Pelajaran</label>
								<div class="controls">
			...
			<div class="span12">
				...
				<div class="widget-box">
					...
					<div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
						<h5>Data Mata Pembelajaran Online</h5>
					</div>
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped ">
							<thead>
								<tr>
									<th>Kode MK</th>
									<th style="width:400px;">Nama Mata Pelajaran</th>
