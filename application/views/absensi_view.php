...
<li class="submenu open"> <a href="#"><i class="icon icon-th-list"></i> <span>Manage Siswa</span> <span
...
<li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Manage Mata Pelajaran</span> <span
			class="icon icon-chevron-down pull-right" style="margin-right: 5px;"></span></a>
	<ul>
...
<div id="content">
	<div id="content-header">
		...
		<h1><span class="icon-briefcase"></span>
			Informasi <small>Absensi Siswa</small></h1>
	</div>
	<hr>
			...
			<div class="span12">
							...
							<div class="accordion-inner">
								<form class="form-inline">
									<table style="width:400px;">
										<tr>
											<td><label for="matakuliahfil">Mata Pelajaran</label></td>
											<td>
				...
				<div class="widget-box">
					<div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
						<h5>Data Absensi Siswa Pembelajaran Online</h5>
					</div>
