...
<li class="submenu open"> <a href="#"><i class="icon icon-print"></i> <span>Laporan</span> <span
	...
	<ul>
		...
		<li><a href="laporan/nilailaporandosen"/a></li>
	</ul>
</li>
</ul>
</div>
...
<div id="content">
	<div id="content-header">
		...
		<h1><span class="icon-briefcase"></span>
			Laporan Absensi <small>E-learning SMA Dr. Soetomo</small></h1>
	</div>
	<hr>
	<div class="container-fluid offset4">
		<form action="<?= $action ?>" method="GET" target="blank">
			<div class="control-group">
				<label class="control-label" for="prodi">Mata Pelajaran</label>
				<div class="controls">
