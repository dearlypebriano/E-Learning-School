...
<li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Manage Mata Pelajaran</span> <span
			class="icon icon-chevron-down pull-right" style="margin-right: 5px;"></span></a>
	<ul>
		<li><a href="matakuliah">Mata Pelajaran</a>
		</li>
...
<li class="submenu open"> <a href="#"><i class="icon icon-print"></i> <span>Laporan</span> <span
	...
	<ul>
		...
		<li class='active'><a href="laporan/nilailaporan"/a></li>
	</ul>
</li>
</ul>
</div>
...
<div id="content">
	<div id="content-header">
		...
		<h1><span class="icon-briefcase"></span>
			Laporan Nilai <small>E-learning SMA Dr. Soetomo</small></h1>
	</div>
	<hr>
	<div class="container-fluid offset4">
		<form action="<?= $action ?>" method="GET" target="blank">
			<div class="control-group">
				<label class="control-label" for="kodemk">Mata Pelajaran</label>
				<div class="controls">
